    ...
    public function save_variation_gallery($variation_id, $i) {
        if (isset($_POST['rtwpvg'])) {
            if (isset($_POST['rtwpvg'][$variation_id])) {
                update_post_meta($variation_id, 'rtwpvg_images', $_POST['rtwpvg'][$variation_id]);
            } else {
    ...
    public function gallery_admin_html($loop, $variation_data, $variation) {
        ...
        <div class="form-row form-row-full rtwpvg-gallery-wrapper">
                ...
                <ul class="rtwpvg-images">
                    ...
                    if (is_array($gallery_images) && !empty($gallery_images)) {
                        foreach ($gallery_images as $image_id):
                            ...
                            ?>
                            <li class="image">
                                <input type="hidden" name="rtwpvg[<?php echo $variation_id ?>][]"
            ...
            <p class="rtwpvg-add-image-wrapper hide-if-no-js">
                <a href="#" data-product_variation_id="<?php echo absint($variation->ID) ?>"
