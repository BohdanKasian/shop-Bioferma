...
?>
	...
	<footer id="colophon" class="site-footer">
        ...
        ?>
        <div class="bx-crm-widget-form-config-wrapper bx-crm-widget-form-copyright-disabled">
            <div id="bx24_form_container_14" class="bx-crm-widget-form-config-sidebar">
				...
				<span class="bx-crm-widget-form-config-sidebar-hamburger">
					...
					<span class="bx-crm-widget-form-config-sidebar-close-item" onclick="popupRightClose()"></span>
				</span>
                    </div>
                    ...
                    <div class="bx-crm-widget-form-config-sidebar-info">
                        ...
                        <div id="bx24_form_inline_loader_container_14" class="">
                            <div class="flexible-middle-width footer-logo-none crm-webform-iframe crm-webform-no-borders crm-webform-no-logo">


                                <div class="content-wrap">
                                    <div class="">
                                        <div class="crm-webform-wrapper">
                                            <div id="crm-web-form-id-14" class="container crm-webform-main-container">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="crm-webform-block crm-webform-default">
                                                            <div class="crm-webform-header-container">
                                                                <h2 class="crm-webform-header">Заказ обратного звонка</h2>
                                                                <p>Пожалуйста укажите Ваши контактные данные и наш менеджер свяжется с Вами в ближайшее время.</p>
                                                            </div>
                                                            <div class="crm-webform-body">
                                                                <?php echo do_shortcode ('[contact-form-7 id="123" title="right-popup-form"]'); ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div><div>
                    <div data-b24-crm-button-shadow="" id="shadow-popup-form-right" class="b24-widget-button-shadow "></div>
                    ...
                    <div dir="ltr" data-b24-crm-button-cont="" id="button-popup-form-right" class="b24-widget-button-wrapper b24-widget-button-position-bottom-right b24-widget-button-visible">
                        ...
                        <div data-b24-crm-button-block="" class="b24-widget-button-social b24-widget-button-hide">
                            ...
                            <a data-b24-crm-button-widget-blank="" data-b24-crm-button-widget="crmform" class="b24-widget-button-social-item b24-widget-button-crmform" title="" data-b24-widget-sort="300" style="background-color: rgb(0, 166, 76); background-image: url(&quot;data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%3E%3Cpath%20fill%3D%22%23ffffff%22%20fill-rule%3D%22evenodd%22%20d%3D%22M22.407%200h-21.1C.586%200%200%20.586%200%201.306v21.1c0%20.72.586%201.306%201.306%201.306h21.1c.72%200%201.306-.586%201.306-1.305V1.297C23.702.587%2023.117%200%2022.407%200zm-9.094%2018.046c0%20.41-.338.737-.738.737H3.9c-.41%200-.738-.337-.738-.737v-1.634c0-.408.337-.737.737-.737h8.675c.41%200%20.738.337.738.737v1.634zm7.246-5.79c0%20.408-.338.737-.738.737H3.89c-.41%200-.737-.338-.737-.737v-1.634c0-.41.337-.737.737-.737h15.923c.41%200%20.738.337.738.737v1.634h.01zm0-5.8c0%20.41-.338.738-.738.738H3.89c-.41%200-.737-.338-.737-.738V4.822c0-.408.337-.737.737-.737h15.923c.41%200%20.738.338.738.737v1.634h.01z%22/%3E%3C/svg%3E&quot;);">
                                <i></i>
                                <span data-b24-crm-button-tooltip="" class="b24-widget-button-social-tooltip">Заказ обратного звонка</span>
                            </a></div>
                        <div data-b24-crm-button-block-button="" class="b24-widget-button-inner-container">
                            <div data-b24-crm-button-block-border="" class="b24-widget-button-inner-mask" style="background: #00a64c;"></div>
                            <div class="b24-widget-button-block">
                                <div data-b24-crm-button-pulse="" class="b24-widget-button-pulse b24-widget-button-pulse-animate" style="border-color: #00a64c;"></div>
