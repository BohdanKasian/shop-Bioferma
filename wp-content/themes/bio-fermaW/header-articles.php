            ...
            <div id="virtualc_482" style="height:86px;" class="virtuals fixbar">
                <div class="allContent" style="width:1001px;height:86px;">
                    <div id="c_482" class="droppable" style="width:1001px;height:86px;">
                        ...
                        <div class="bi irz" id="i489" style="top:37px;left:160px;z-index:10;width:auto;">
                            <?php
                            $args = array(
                                'theme_location' => 'articles_menu',
                                'menu_class'     => 'nav navbar-nav h100',
                                'items_wrap'     => '<ul id="%1$s" class="%2$s">%3$s</ul>',
                            );
                            wp_nav_menu($args);?>
                        </div>
                        <a href="/#ac_485" class="nodec"><div class="bi" id="i488" style="top:0px;left:0px;z-index:13;"><img src="<?php echo get_template_directory_uri(); ?>/assets/files/block/s-logo-biofm-min-min.png@times=1517569718" width="131" height="80" alt="" title="" class="bl center"></div></a>
